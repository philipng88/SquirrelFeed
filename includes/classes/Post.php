...
class Post {
    ...
    public function submitPost($body, $user_to, $imageName) {
        ...
        if ($check_empty != "" || $imageName != "") {
            ...
            // words to exclude from tending list
                    ...
                    $(document).ready(() => {
                        $('#post<?php echo $id; ?>').on('click', () => {
                            bootbox.confirm({
                                ...
                                callback: result => {
                                    $.post("includes/form_handlers/delete_post.php?post_id=<?php echo $id; ?>", { result });
                                    if (result) {
                                       location.reload();
                                    }
                                }
...
<?php 
                    ...
                    echo "<p>You cannot view this post because you are not friends with this user</p>";
                    return;
                }
        } else {
            echo "<p>No post found. If you clicked on a link, it may be broken</p>";
            return;
        }
        echo $str;
    }
